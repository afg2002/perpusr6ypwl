  ...
  <div class="container">
    ...
    <form method="GET" action="dashboard.php">
      <div class="field has-addons">
        <div class="control">
          <input class="input" type="text" placeholder="Cari buku" name="search"
      ...
      if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          $stok = $row['stok'];
           ...
           // Memeriksa apakah stok buku adalah 0 atau kurang
          $disabled = ($stok <= 0) ? 'disabled' : '';
          $buttonText = ($stok <= 0) ? 'Stok Habis' : 'Pinjam Buku';

          // Memeriksa apakah anggota telah mencapai batas maksimal peminjaman
          $disabled = ($jumlah_pinjam >= $batas_max_pinjam) ? 'disabled' : '';
            ...
            <div class="card" style="height:100%;">
              <div class="card-content">
                <div class="content" style="height: 200px;">
                  <h3 class="title is-5"><a href="detail_buku.php?id=<?php echo $id; ?>"><?php echo $judul; ?></a></h3>
                  <p class="subtitle is-6">Penulis: <?php echo $penulis; ?></p>
                  <p class="subtitle is-6">Penerbit: <?php echo $penerbit; ?></p>
                  <p class="subtitle is-6">Tahun Terbit: <?php echo $tahun_terbit; ?></p>
                  <p class="subtitle is-6">Stok: <span id="stok-<?php echo $id; ?>"><?php echo $stok; ?></span></p>
                </div>
                <div class="buttons is-centered">
                <button id="pinjamBtn" class="button is-primary" onclick="showConfirmation(<?php echo $id; ?>)" <?php echo $disabled; ?>>
                  Pinjam Buku
                </button>
        ...
        // Jika tidak ada data buku yang ditemukan
